...
import { WarehousObject } from '../types/interfaces';
import { AppFunctions, FUNCTIONS_INJECTION_KEY } from '../types/functions';
import WarehouseS3 from './WarehouseS3.vue';
import WarehouseGCS from './WarehouseGCS.vue';
import WarehouseAzure from './WarehouseAzure.vue';
import WarehouseJSON from './WarehouseJSON.vue';
...
async function createWarehouse(warehouseObject: WarehousObject) {
  try {
    ...
    if (!functions) throw new Error('App functions not available');
    if (!functions.createWarehouse) throw new Error('createWarehouse function not available');
