 ...
 */
export const moveNamespace = <ThrowOnError extends boolean = false>(options: Options<MoveNamespaceData, ThrowOnError>): RequestResult<MoveNamespaceResponses, MoveNamespaceErrors, ThrowOnError> => (options.client ?? client).post<MoveNamespaceResponses, MoveNamespaceErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
