...
import type { GetConfigData, GetConfigResponses, GetConfigErrors, GetTokenData, GetTokenResponses, GetTokenErrors, ListNamespacesData, ListNamespacesResponses, ListNamespacesErrors, CreateNamespaceData, CreateNamespaceResponses, CreateNamespaceErrors, DropNamespaceData, DropNamespaceResponses, DropNamespaceErrors, LoadNamespaceMetadataData, LoadNamespaceMetadataResponses, LoadNamespaceMetadataErrors, NamespaceExistsData, NamespaceExistsResponses, NamespaceExistsErrors, UpdatePropertiesData, UpdatePropertiesResponses, UpdatePropertiesErrors, ListTablesData, ListTablesResponses, ListTablesErrors, CreateTableData, CreateTableResponses, CreateTableErrors, PlanTableScanData, PlanTableScanResponses, PlanTableScanErrors, CancelPlanningData, CancelPlanningResponses, CancelPlanningErrors, FetchPlanningResultData, FetchPlanningResultResponses, FetchPlanningResultErrors, FetchScanTasksData, FetchScanTasksResponses, FetchScanTasksErrors, RegisterTableData, RegisterTableResponses, RegisterTableErrors, DropTableData, DropTableResponses, DropTableErrors, LoadTableData, LoadTableResponses, LoadTableErrors, TableExistsData, TableExistsResponses, TableExistsErrors, UpdateTableData, UpdateTableResponses, UpdateTableErrors, LoadCredentialsData, LoadCredentialsResponses, LoadCredentialsErrors, RenameTableData, RenameTableResponses, RenameTableErrors, ReportMetricsData, ReportMetricsResponses, ReportMetricsErrors, CommitTransactionData, CommitTransactionResponses, CommitTransactionErrors, ListViewsData, ListViewsResponses, ListViewsErrors, CreateViewData, CreateViewResponses, CreateViewErrors, DropViewData, DropViewResponses, DropViewErrors, LoadViewData, LoadViewResponses, LoadViewErrors, ViewExistsData, ViewExistsResponses, ViewExistsErrors, ReplaceViewData, ReplaceViewResponses, ReplaceViewErrors, RenameViewData, RenameViewResponses, RenameViewErrors } from './types.gen';
...
export const listNamespaces = <ThrowOnError extends boolean = false>(options: Options<ListNamespacesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ListNamespacesResponses, ListNamespacesErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const createNamespace = <ThrowOnError extends boolean = false>(options: Options<CreateNamespaceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateNamespaceResponses, CreateNamespaceErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const dropNamespace = <ThrowOnError extends boolean = false>(options: Options<DropNamespaceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DropNamespaceResponses, DropNamespaceErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const loadNamespaceMetadata = <ThrowOnError extends boolean = false>(options: Options<LoadNamespaceMetadataData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LoadNamespaceMetadataResponses, LoadNamespaceMetadataErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const namespaceExists = <ThrowOnError extends boolean = false>(options: Options<NamespaceExistsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).head<NamespaceExistsResponses, NamespaceExistsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const updateProperties = <ThrowOnError extends boolean = false>(options: Options<UpdatePropertiesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UpdatePropertiesResponses, UpdatePropertiesErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const createTable = <ThrowOnError extends boolean = false>(options: Options<CreateTableData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateTableResponses, CreateTableErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const planTableScan = <ThrowOnError extends boolean = false>(options: Options<PlanTableScanData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PlanTableScanResponses, PlanTableScanErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const cancelPlanning = <ThrowOnError extends boolean = false>(options: Options<CancelPlanningData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<CancelPlanningResponses, CancelPlanningErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const fetchPlanningResult = <ThrowOnError extends boolean = false>(options: Options<FetchPlanningResultData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FetchPlanningResultResponses, FetchPlanningResultErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const fetchScanTasks = <ThrowOnError extends boolean = false>(options: Options<FetchScanTasksData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<FetchScanTasksResponses, FetchScanTasksErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const registerTable = <ThrowOnError extends boolean = false>(options: Options<RegisterTableData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RegisterTableResponses, RegisterTableErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const dropTable = <ThrowOnError extends boolean = false>(options: Options<DropTableData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DropTableResponses, DropTableErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const loadTable = <ThrowOnError extends boolean = false>(options: Options<LoadTableData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LoadTableResponses, LoadTableErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const tableExists = <ThrowOnError extends boolean = false>(options: Options<TableExistsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).head<TableExistsResponses, TableExistsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const updateTable = <ThrowOnError extends boolean = false>(options: Options<UpdateTableData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UpdateTableResponses, UpdateTableErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const loadCredentials = <ThrowOnError extends boolean = false>(options: Options<LoadCredentialsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LoadCredentialsResponses, LoadCredentialsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const renameTable = <ThrowOnError extends boolean = false>(options: Options<RenameTableData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RenameTableResponses, RenameTableErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const reportMetrics = <ThrowOnError extends boolean = false>(options: Options<ReportMetricsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ReportMetricsResponses, ReportMetricsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const commitTransaction = <ThrowOnError extends boolean = false>(options: Options<CommitTransactionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CommitTransactionResponses, CommitTransactionErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const listViews = <ThrowOnError extends boolean = false>(options: Options<ListViewsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ListViewsResponses, ListViewsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const dropView = <ThrowOnError extends boolean = false>(options: Options<DropViewData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DropViewResponses, DropViewErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const loadView = <ThrowOnError extends boolean = false>(options: Options<LoadViewData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LoadViewResponses, LoadViewErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const viewExists = <ThrowOnError extends boolean = false>(options: Options<ViewExistsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).head<ViewExistsResponses, ViewExistsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const replaceView = <ThrowOnError extends boolean = false>(options: Options<ReplaceViewData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ReplaceViewResponses, ReplaceViewErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const renameView = <ThrowOnError extends boolean = false>(options: Options<RenameViewData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RenameViewResponses, RenameViewErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
